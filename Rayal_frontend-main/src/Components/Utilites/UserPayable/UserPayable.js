...
const BranchPayable = () => {
    ...
    const ApproveFunction = (row) => {
        ...
        GetPolicyFindbyId(row._id).then((res) => {
            ...
            setFormType('edit')
            setPayableType('userPayable')
        })
        GetUserpayablePercentage(row._id).then((res) => {
            setOpenLoader(false)
            setOpenDrawer(true);
    ...
    const PendingData = () => {
        setOpenLoader(true)
        FilterPolicyList({
            companyId: null, bookingCodeId: null,
    ...
    return (
        <>
            ...
            <Box sx={{ flexGrow: 1 }} mt={4}>
                <Grid container className="Master_Header_Container" spacing={2}>
                    <Grid item xs={12} sm={3}>
                        <Typography className="Master_Header_Heading">User Payable</Typography>
                    </Grid>
                                ...
                                {visibleRows?.map((row, index) => {
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="left">{row?.userPayable?.Total}</TableCell>
                                            ...
                                            <TableCell align="center">
                                                <Box className="ActionIcons d-flex" gap={2}>
                                                    ...
                                                    <Tooltip title="View">
                                                        <RemoveRedEyeIcon onClick={() => GetPolicyFindbyIdFunction(row)} />
                                                    </Tooltip>
            ...
            >{
                    openDrawer ? <CommonPayableDrawer UserPayablePercentage={payablePercentage} setOpenDrawer={setOpenDrawer} formType={formType} selectedData={selectedData} path={"userPayable"} GetData={GetData} payableType={payableType} /> : null
                }
            </Drawer>
